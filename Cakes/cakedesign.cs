...
namespace Cakes
{
    public class CakeDesign
    {
        ...
        static public int Ck_amountoflevels = 0;
        ...
        public static void Menu(int position)
        {
            ...
            while (key.Key != ConsoleKey.Escape)
            {
                ...
                if (position == 7 && key.Key == ConsoleKey.Enter)
                {
                    if (Ck_shape != "" && Ck_size != "")
                    {
                        CakeDesign.CakeList.Add(new CakeDesign(Ck_shape, Ck_size, Ck_price));
                        return;
                ...
                if (Ck_shape != "" || Ck_size != "")
                {
                    ...
                    Console.Write($"{Ck_shape}, {Ck_size}");
                }
